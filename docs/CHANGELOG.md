...
### Added
- reusable consumer-facing release.yml workflow
...
### Fixed
- use step outcomes instead of cancelled() in the composite action
...
### Fixed
- bind differential phases to CLI revision

## [2.15.8] - 2026-08-25

### Fixed
- reconcile differential evidence after PR closure
...
### Fixed
- bound action setup subprocesses
...
### Fixed
- compare test failures by identity
...
### Added
- configure source build profiles
...
### Fixed
- resolve sharded Test results across reruns
...
### Fixed
- skip empty matrices for sharded test workflows
...
### Fixed
- isolate downloaded test archives
...
### Fixed
- make shard replays hermetic [AI: OpenAI gpt-5.6-terra via OpenCode - workflow and contract tests]
...
### Fixed
- surface observation terminal diagnostics
